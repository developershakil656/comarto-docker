...
<div>
    <div class="">
        <swiper :navigation="true" :pagination="{ clickable: true }" :modules="modules" :loop="true" :speed="1000" :autoplay="{
            delay: 5000,
...
<style>
/* responsive aspect ratio for main slider */
.main-swiper {
    aspect-ratio: 4 / 1.9;
    /* width: 100%;
    height: auto; */
