        ...
        <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <div v-if="review" class="space-y-4">
                    ...
                    <div class="space-y-3">
                        <div v-for="(reply, index) in review.replies" :key="`${reply.id || reply._id || index}-${reply.images ? reply.images.length : 0}`" class="flex items-start space-x-3">
                            <img :src="reply.user.profile" alt="owner" class="w-8 h-8 rounded-full flex-shrink-0" />
                            <div class="flex-1">
                                <!-- Reply Content -->
                                    ...
                                    <div v-else>
                                        ...
                                        <div v-if="replyForm.images.length > 0" class="mt-3 flex space-x-2">
                                            <div v-for="(image, imgIndex) in replyForm.images" :key="imgIndex" class="relative">
                                                <img :src="image.url" alt="Reply image" class="w-24 h-24 object-cover rounded border border-gray-200 shadow-sm" />
            ...
            <div v-if="currentUser && review && editingReplyIndex === null" class="border-t bg-gray-50 p-4 flex-shrink-0">
                ...
                <div class="flex items-start space-x-3">
                    <img :src="currentUser?.business?.id === businessId ? currentUser?.business?.business_profile : currentUser?.profile" alt="avatar" class="w-8 h-8 rounded-full flex-shrink-0" />
                    <div class="flex-1">
                        <div class="relative">
